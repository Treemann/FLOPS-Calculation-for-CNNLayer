input_shape = (3 ,100 ,100) # Format:(channels, rows,cols)
conv_filter = (32 ,3 ,3 ,3)  # Format: (num_filters, channels, rows, cols)
stride = 1
padding = 1
activation = 'relu'
...
num_instances_per_filter *= ((input_shape[2] - conv_filter[2] + 2 * padding) / stride) + 1  # multiplying with cols
